...
set term pngcairo #size 400,1000
...
p 'e1' every 100 using (1):1,'e2' every 100 using (2):1,'e3' every 100 using (3):1,'e4' every 100 using (4):1,'e5' every 100 using (5):1,'e6' every 100 using (6):1,'e7' every 100 using (7):1,'e8' every 100 using (8):1,'e9' every 100 using (9):1,'e10' every 100 using (10):1,'e11' every 100 using(11):1,'e12' every 100 using (12):1,'e13' every 100 using (13):1,'e14' every 100 using (14):1,'e15' every 100 using (15):1, 'e16' every 100 using (16):1, 'all.dat' every 1000 using (19):1
